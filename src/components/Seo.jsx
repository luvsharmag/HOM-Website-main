  ...
  return (
    ...
    <div className='ml-24 flex'>
      <div className='flex flex-col gap-8'>
        <h1 className='text-7xl font-extrabold'>SEO</h1>
        <p className='text-xl'>Learn how to level up your presence in online search results to drive site visits, qualified leads, and conversions!</p>
      ...
      <div>
        <img  src="https://www.webfx.com/wp-content/uploads/2023/10/seo-header1.png" alt="" />
      </div>
    </div>
    <div className='mx-24'>
