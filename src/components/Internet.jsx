...
const Internet = () => {
  return (
    ...
    <div className='flex flex-col gap-8'>
      <h1 className='text-7xl font-extrabold'>Internet</h1>
      <p className='text-xl'>Unlock the secrets of internet marketing, and boost your reach and impact online to attract more users, interactions, and digital transactions!</p>
    ...
    <div>
      <img  src="https://www.webfx.com/wp-content/uploads/2023/10/internet-header1.png" alt="" />
    </div>
  </div>
  <div className='mx-24'>
